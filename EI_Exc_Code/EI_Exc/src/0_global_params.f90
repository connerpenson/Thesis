Module global_params
    ...
    integer, parameter :: num_gamma_Q = 8, l_max = 4, n_max = 4, num_Q = 19, num_Q_ = 500, skip_en = 4, num_scatE = 85, energy_step_num = 50
    ...
    character(len=1), dimension(n_max) :: state_names
    ...
    integer, dimension(4,4) ::  write_list
